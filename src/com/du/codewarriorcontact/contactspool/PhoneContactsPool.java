...
public class PhoneContactsPool implements IContactsPool {
	...
	// ////
	// ////
	// ops.add(ContentProviderOperation.newInsert(RawContacts.CONTENT_URI).withValue(RawContacts.ACCOUNT_TYPE,
	// null).withValue(RawContacts.ACCOUNT_NAME, null).build());
	// //// try {
	...
	// personalVcard.getFirstName()).build());
	// //
	...
	// // Uri dataUri =
	// ctx.getContentResolver().insert(android.provider.ContactsContract.Data.CONTENT_URI,
	// values);
	// }
