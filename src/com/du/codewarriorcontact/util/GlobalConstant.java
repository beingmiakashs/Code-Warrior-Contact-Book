...
//	}
	...
	public static void showCustomToast(Activity ac, String msg){
		...
		toastView.setBackgroundColor(Color.TRANSPARENT|Color.BLACK);
		
		TextView tv = new TextView(ac.getApplicationContext());
		tv.setTypeface(GlobalConstant.banglaTypeFace);
		tv.setText(msg);
		tv.setTextSize(20);
